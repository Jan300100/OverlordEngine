...
public:
	...
	InstancedRenderer* GetInstancedRenderer()  const { return m_pInstancedRenderer; };
...
protected:
	...
	//update pp
	void AddPostProcessingEffect(PostProcessingMaterial* pMat);
	void RemoveostProcessingEffect(PostProcessingMaterial* pMat);

private:
	friend class SceneManager;

	void RootInitialize(GA::Interface* pRenderer);
	void RootUpdate();
	void RootDraw();
	...
	//instancedRenderer
	InstancedRenderer* m_pInstancedRenderer;
};
