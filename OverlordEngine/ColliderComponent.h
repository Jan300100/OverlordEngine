...
public:
	...
	ColliderComponent(std::shared_ptr<physx::PxGeometry>& geometry, const physx::PxMaterial& material, physx::PxTransform localPose = physx::PxTransform(physx::PxIdentity));
