...
public:
	...
	void SetEffectVariables(const GameContext& gameContext, ModelComponent* pModelComponent, bool matIdChanged = true);
	ID3DX11EffectTechnique* GetTechnique() const { return m_pTechnique; }
	ID3D11InputLayout* GetInputLayout() const { return m_pInputLayout; }
	bool UsesTesselation() const;

	virtual ID3DX11EffectTechnique* GetShadowTechnique() { return nullptr; }

protected:

	void SetTechnique(unsigned int id);
