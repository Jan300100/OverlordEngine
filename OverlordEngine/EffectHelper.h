...
private:
	static std::map<ILSemantic, std::wstring> create_map()
	{
		...
		m.insert(std::pair<ILSemantic, std::wstring>(ILSemantic::INSTANCEID, L"SV_InstanceID"));
		m.insert(std::pair<ILSemantic, std::wstring>(ILSemantic::INSTANCE1F, L"INSTANCE1F"));
		m.insert(std::pair<ILSemantic, std::wstring>(ILSemantic::INSTANCE2F, L"INSTANCE2F"));
		m.insert(std::pair<ILSemantic, std::wstring>(ILSemantic::INSTANCE3F, L"INSTANCE3F"));
		m.insert(std::pair<ILSemantic, std::wstring>(ILSemantic::INSTANCE4F, L"INSTANCE4F"));
		return m;
	}
