...
class CameraComponent: public BaseComponent
{
	...
	DirectX::XMFLOAT4X4 m_View, m_Projection, m_ProjectionInverse, m_ViewInverse, m_ViewProjection, m_ViewProjectionInverse;
...
public:
	...
	const DirectX::XMFLOAT4X4& GetProjectionInverse() const {return m_ProjectionInverse;}
	...
	GameObject* PickMouse(const GameContext& gameContext, CollisionGroupFlag ignoreGroups = static_cast<CollisionGroupFlag>(0)) const;
	physx::PxRaycastBuffer Pick(DirectX::XMFLOAT2 pos, CollisionGroupFlag ignoreGroups = static_cast<CollisionGroupFlag>(0)) const;
