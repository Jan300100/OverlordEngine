...
struct SkinnedVertex
{
	SkinnedVertex(DirectX::XMFLOAT3 position, DirectX::XMFLOAT3 normal, DirectX::XMFLOAT4 color) :
		...
		OriginalVertex(position, normal, color), WeightB0{ 1.0f }, WeightB1{ 0.0f }
	{}
	SkinnedVertex(DirectX::XMFLOAT3 position, DirectX::XMFLOAT3 normal, DirectX::XMFLOAT4 color, float weightB0, float weightB1) :
		TransformedVertex(position, normal, color),
		OriginalVertex(position, normal, color), WeightB0{ weightB0 }, WeightB1{ weightB1 }
	{}
	VertexPosNormCol TransformedVertex;
	VertexPosNormCol OriginalVertex;
	float WeightB0, WeightB1;
};