...
PS_Input MainVS(VS_Input input) {
    ...
    float2 windDisplacement = (gWindDirection * (input.Position.y * gHeightInfluence) //the higher above the ground, the more the wind affects the vertex
